            ...
            <div className="flex flex-col items-center">
              <div className="flex items-center gap-2 sm:gap-3">
                <a 
                  ...
                  style={isRetro ? { 
                    borderColor: '#00FFFF',
                    boxShadow: '0 0 10px rgba(34,211,238,0.4), 3px 3px 0 #000'
                  } : undefined}
                  title="Facebook"
                >
                  <svg className="w-4 h-4 sm:w-5 sm:h-5" viewBox="0 0 24 24" fill={isRetro ? "#00FFFF" : "currentColor"} style={isRetro ? { filter: 'drop-shadow(0 0 4px #00FFFF)' } : undefined}>
                ...
                <a 
                  ...
                  style={isRetro ? { 
                    borderColor: '#FF00FF',
                    boxShadow: '0 0 10px rgba(255,0,255,0.4), 3px 3px 0 #000'
                  } : undefined}
                  title="Instagram"
                >
                  <svg className="w-4 h-4 sm:w-5 sm:h-5" viewBox="0 0 24 24" fill={isRetro ? "#FF00FF" : "currentColor"} style={isRetro ? { filter: 'drop-shadow(0 0 4px #FF00FF)' } : undefined}>
                ...
                <a 
                  ...
                  style={isRetro ? { 
                    borderColor: '#FFFF00',
                    boxShadow: '0 0 10px rgba(255,255,0,0.4), 3px 3px 0 #000'
                  } : undefined}
                  title="TikTok"
                >
                  <svg className="w-4 h-4 sm:w-5 sm:h-5" viewBox="0 0 24 24" fill={isRetro ? "#FFFF00" : "currentColor"} style={isRetro ? { filter: 'drop-shadow(0 0 4px #FFFF00)' } : undefined}>
                ...
                <a 
                  ...
                  style={isRetro ? { 
                    borderColor: '#39FF14',
                    boxShadow: '0 0 10px rgba(57,255,20,0.4), 3px 3px 0 #000'
                  } : undefined}
                  title="X (Twitter)"
                >
                  <svg className="w-4 h-4 sm:w-5 sm:h-5" viewBox="0 0 24 24" fill={isRetro ? "#39FF14" : "currentColor"} style={isRetro ? { filter: 'drop-shadow(0 0 4px #39FF14)' } : undefined}>
              ...
              <div className="text-center mt-2">
                ...
                <div className="flex items-center justify-center gap-2">
                  <a 
                    ...
                    style={isRetro ? { color: '#FF00FF', textShadow: '0 0 6px rgba(255,0,255,0.5)' } : undefined}
                  >
                  ...
                  <Link 
                    ...
                    style={isRetro ? { color: '#39FF14', textShadow: '0 0 6px rgba(57,255,20,0.5)' } : undefined}
                  >
                    {isRetro ? '[ LEGAL ]' : 'Legal'}
                  </Link>
                  <span className={`text-xs ${isRetro ? '' : 'text-muted-foreground/50'}`} style={isRetro ? { color: '#FFFF00' } : undefined}>
                  ...
                  <span 
                    className={`text-xs font-mono ${isRetro ? 'uppercase' : 'text-muted-foreground/70'}`}
                    style={isRetro ? { color: '#00FFFF', textShadow: '0 0 6px rgba(34,211,238,0.5)' } : undefined}
                  >
                    {isRetro ? '[ JAC ]' : 'JAC'}
                  </span>
                </div>
