...
export const MUSIC_LIBRARY: Genre[] = [
  ...
  },
  {
    ...
    songs: [
      ...
      { title: 'N.Y. State of Mind', artist: 'Nas', videoId: 'hI8A14Qcv68', genre: 'Hip Hop' },
      { title: 'Juicy', artist: 'The Notorious B.I.G.', videoId: '_JZom_gVfuw', genre: 'Hip Hop' },
      { title: 'California Love', artist: '2Pac ft. Dr. Dre', videoId: '5wBTdfAkqGU', genre: 'Hip Hop' },
      { title: 'Gin and Juice', artist: 'Snoop Dogg', videoId: 'DI3yXg-sX5c', genre: 'Hip Hop' },
      { title: 'Mo Money Mo Problems', artist: 'The Notorious B.I.G.', videoId: 'gUhRKVIjJtw', genre: 'Hip Hop' },
      { title: 'Gold Digger', artist: 'Kanye West', videoId: '6vwNcNOTVzY', genre: 'Hip Hop' },
      { title: 'Stronger', artist: 'Kanye West', videoId: 'PsO6ZnUZI0g', genre: 'Hip Hop' },
      { title: 'Power', artist: 'Kanye West', videoId: 'L53gjP-TtGE', genre: 'Hip Hop' },
      { title: 'Empire State of Mind', artist: 'Jay-Z ft. Alicia Keys', videoId: '0UjsXo9l6I8', genre: 'Hip Hop' },
      { title: '99 Problems', artist: 'Jay-Z', videoId: 'WwoM5fLITfk', genre: 'Hip Hop' },
    ]
  },
  {
    name: 'Drill',
  ...
  },
  {
    ...
    songs: [
      ...
      { title: 'Closer', artist: 'The Chainsmokers ft. Halsey', videoId: 'PT2_F-1esPk', genre: 'Pop' },
      { title: 'Roses', artist: 'SAINt JHN', videoId: 'ele2DMU49Jk', genre: 'Pop' },
      { title: 'Señorita', artist: 'Shawn Mendes & Camila Cabello', videoId: 'Pkh8UtuejGw', genre: 'Pop' },
      { title: 'Stitches', artist: 'Shawn Mendes', videoId: 'VbfpW0pbvaU', genre: 'Pop' },
      { title: 'Treat You Better', artist: 'Shawn Mendes', videoId: 'lY2yjAdbvdQ', genre: 'Pop' },
      { title: 'bad guy', artist: 'Billie Eilish', videoId: 'DyDfgMOUjCI', genre: 'Pop' },
      ...
      { title: 'Sorry', artist: 'Justin Bieber', videoId: 'fRh_vgS2dFE', genre: 'Pop' },
    ]
  },
  {
    name: 'R&B',
  ...
  },
  {
    ...
    songs: [
      ...
      { title: 'Super Freaky Girl', artist: 'Nicki Minaj', videoId: 'QqBf1I5kvj8', genre: 'Top Hits' },
      { title: 'About Damn Time', artist: 'Lizzo', videoId: 'IXXxciRUMzE', genre: 'Top Hits' },
      { title: 'Vegas', artist: 'Doja Cat', videoId: 'zLxNgQU0Qow', genre: 'Top Hits' },
      { title: 'Woman', artist: 'Doja Cat', videoId: 'Lq548sQ2H7s', genre: 'Top Hits' },
      { title: 'Running Up That Hill', artist: 'Kate Bush', videoId: 'wp43OdtAAkM', genre: 'Top Hits' },
